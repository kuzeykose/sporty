  ...
  return (
    <>
      <div>
            ...
            <div className="fixed inset-0 flex">
              ...
              >
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex py-8 grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2">
        ...
        <div className="hidden lg:absolute lg:min-h-screen lg:z-10 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}

...
const tabs = [
  { name: 'Plans', href: '#', icon: UserIcon, current: false },
  { name: 'Settings', href: '#', icon: BuildingOfficeIcon, current: false },
  { name: 'User', href: '#', icon: UsersIcon, current: true },
];
